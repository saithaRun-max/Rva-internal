  ...
  return (
    <div>
      {theme == "dark" ? (
        ...
        >
          <img
            src="data:image/svg+xml;base64,"
            alt="moon logo"
            className=""
          />
        </Button>
